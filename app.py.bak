...
MASTER_ACCOUNT_ID = '6754883343'  # Chỉnh sửa theo tài khoản chính của bạn
    ...
    def execute_command(self, command, *args):
        ...
        if '/xza' in command[:5]:
                try:
                        ...
                        if not team_code:
                                return "No team code provided for /xza"

                        self.id = team_code
                        self.nm = account_name
                        print(f"[{self.account_id}] Executing /xza for team code {self.id} with name {self.nm}")
                        ...
                        if self.account_id == MASTER_ACCOUNT_ID:
                                ...
                                return f"/xza master command executed successfully"
                        ...
                        # Ghost account logic (uses master info)
                                ...
                                return f"/xza ghost command executed using master data"
...
def execute_command_all():
    ...
    ghost_names = {
        "4134172836": "ig: @DeV_Xzanja3",
        "4130944097": "XZA IS THE BEST",
}
