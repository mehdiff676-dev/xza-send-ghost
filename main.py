...
def ArA_CoLor():
    Tp = [
        # 🔴 الأحمر الزاهي
        "[FF0000]","[FA8072]","[E9967A]","[F08080]","[FF6347]","[FF4500]","[FF5F1F]","[FF2400]","[FF6F61]","[FF7F50]",
        
        # 🟠 البرتقالي الفاتح
        "[FFA500]","[FF8C00]","[FF7F00]","[FF7518]","[FF6700]","[FFB347]","[FFDEAD]","[FFE4B5]","[FFDAB9]","[FFE4C4]","[F4A460]",
        
        # 🟡 الأصفر / الذهبي الزاهي
        "[FFFF00]","[FFD700]","[FFFACD]","[FAFAD2]","[EEE8AA]","[F0E68C]","[FFC300]","[F1C40F]","[F39C12]","[FFEA00]","[FFF44F]",
        
        # 🟢 الأخضر الفاتح
        "[00FF00]","[32CD32]","[7CFC00]","[7FFF00]","[ADFF2F]","[98FB98]","[90EE90]","[66CDAA]","[20B2AA]","[3CB371]",
        
        # 🔵 الأزرق الفاتح
        "[1E90FF]","[4169E1]","[6495ED]","[87CEEB]","[87CEFA]","[00BFFF]","[B0E0E6]","[ADD8E6]",
        
        # 🟣 البنفسجي / الوردي الفاتح
        "[BA55D3]","[DA70D6]","[DDA0DD]","[EE82EE]","[FF00FF]","[DB7093]","[FF1493]","[FF69B4]","[FFB6C1]","[FFC0CB]","[E75480]",
        
        # ⚪ الأبيض ودرجاته
        "[FFFFFF]","[F8F8FF]","[F5F5F5]","[FFFAFA]","[F0F8FF]","[E6E6FA]","[FFF0F5]",
        
        # 🌈 ألوان سماوي/تركواز زاهية
        "[00FFFF]","[40E0D0]","[48D1CC]","[00CED1]","[7FFFD4]","[AFEEEE]","[76EEC6]","[E0FFFF]","[F0FFF0]","[F5FFFA]","[F0FFFF]",
        
        # ✨ ألوان باستيل / فاتحة إضافية
        "[FFEFD5]","[FFF5EE]","[FAEBD7]","[FFEBCD]","[FFF8DC]","[FDF5E6]","[F5DEB3]","[FFFACD]"
    ]
    return random.choice(Tp)
